...
public class TransportAdvancementGenerator extends BCBaseAdvancementGenerator {
    ...
    public TransportAdvancementGenerator(PackOutput output, ExistingFileHelper fileHelperIn, CompletableFuture<HolderLookup.Provider> registries) {
    ...
    protected void registerAdvancements(Consumer<AdvancementHolder> consumer, ExistingFileHelper fileHelper, HolderLookup.Provider registries) {
        // pipe_dream
        AdvancementHolder pipe_dream = Advancement.Builder.advancement().display(
        ...
        // plugging_the_gap
        AdvancementHolder plugging_the_gap = Advancement.Builder.advancement().display(
        ...
        // pipe_logic
        AdvancementHolder pipe_logic = Advancement.Builder.advancement().display(
        ...
        // all_plugged_up
        AdvancementHolder all_plugged_up = Advancement.Builder.advancement().display(
        ...
        AdvancementHolder categorizing_with_colors = Advancement.Builder.advancement().display(
        ...
        AdvancementHolder logic_transportation = Advancement.Builder.advancement().display(
        ...
        AdvancementHolder colorful_electrician = Advancement.Builder.advancement().display(
        ...
        // extended_logic
        AdvancementHolder extended_logic = Advancement.Builder.advancement().display(
        ...
        AdvancementHolder pipe_diversification = Advancement.Builder.advancement().display(
        ...
        // pipe_fanatic
        AdvancementHolder pipe_fanatic = Advancement.Builder.advancement().display(
        ...
        // sealing_fluids
        AdvancementHolder sealing_fluids = Advancement.Builder.advancement().display(
        ...
        AdvancementHolder too_many_pipe_filters = Advancement.Builder.advancement().display(
                        Items.GREEN_DYE,
